...
const allPrompts = [
	// Creative & Imaginative
	{
		...
		prompt:
			"Imagine and describe a new species that might evolve on Earth in the distant future.",
	},
	{
		icon: "plane",
		...
		prompt:
			"What are some lesser-known vacation destinations that offer incredible experiences?",
	},
	{
		icon: "wand",
	...
	// Philosophy & Deep Thinking
	{
		...
		prompt:
			"Explain the Ship of Theseus paradox and its implications for identity and change.",
	},
	{
		icon: "hand",
	...
	},
	{
		...
		prompt:
			"How would a truly universal human language function, and what features would it have?",
	},
	...
	},
	{
		...
		prompt:
			"What would be required to establish a self-sustaining human colony on another planet?",
	},
	{
		icon: "wand",
		...
		prompt:
			"What are the most fascinating unexplained mysteries of the deep ocean?",
	},
	...
	// Arts & Culture
	{
		...
		prompt:
			"How is technology changing the way art is created, shared, and experienced?",
	},
	{
		icon: "wand",
		...
		prompt:
			"What elements are essential for creating a compelling fictional world or universe?",
	},
	{
		icon: "wand",
		...
		prompt:
			"What innovations are changing how music is created and experienced?",
	},
	...
	// Practical & Everyday
	{
		...
		prompt:
			"What are the most effective productivity techniques for managing a busy schedule?",
	},
	{
		icon: "wand",
	...
	},
	{
		...
		prompt:
			"What techniques can help someone learn new skills or subjects more effectively?",
	},
	...
	// Fun & Hypothetical
	{
		...
		subtitle: "Creative Challenge",
		prompt:
			"Imagine some unique superpowers that come with interesting downsides or limitations.",
	},
	{
		icon: "plane",
	...
	// Emotional & Personal
	{
		...
		prompt:
			"What does a truly successful life mean to you beyond conventional measures?",
	},
	{
		icon: "hand",
		...
		prompt:
			"What does scientific research tell us about what truly makes humans happy?",
	},
	{
		icon: "wand",
		...
		prompt:
			"Which skills will be most valuable and resistant to automation in the future?",
	},
