...
import { FiInfo, FiMoon, FiSettings, FiSun } from "react-icons/fi";
				...
				>
					<div className="p-6">
						...
						<div className="mb-6">
							<MaxTokensSelector
								maxTokens={maxTokens}
								onChangeMaxTokens={handleMaxTokensChange}
							/>
						</div>
									...
									<div className="relative inline-block ml-2 group">
										...
										<div className="absolute left-1/2 bottom-full mb-2 -translate-x-1/2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 w-64 p-2 rounded bg-gray-800 text-white text-xs shadow-lg z-50">
											<div className="relative">
												A system message helps set the behavior of the
												assistant. It provides initial instructions that guide
												the AI&apos;s responses.
